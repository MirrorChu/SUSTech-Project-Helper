...
from items.users.views import LoginView,ChangePasswordView,ShowPersonalDataView,UploadFile,DownloadFile,Test,StudentGetAllProject
...
urlpatterns = [
    ...
    path('stugetprojects',StudentGetAllProject.as_view())
